...
1. Пожалуйста, относитесь друг к другу с уважением. Любые оскорбления неприемлемы.

2. Мы не публикуем спам и откровенный контент.

В остальном же у вас есть полная свобода действия! Если ваш анонимный пост одобрен модераторами, он будет опубликован в t.me/overheard_at_shad в ближайшее время.
"""
